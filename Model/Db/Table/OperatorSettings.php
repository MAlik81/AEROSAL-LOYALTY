...
class Migachat_Model_Db_Table_OperatorSettings extends Core_Model_Db_Table
{
    protected $_name = "migachat_operator_settings"; //Database table name
    protected $_primary = "migachat_operator_setting_id"; //name of primary key column
